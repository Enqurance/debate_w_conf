...
from util import GSMDebateCompare, GSMDebateSingle, StrategyQADebateCompare, StrategyQADebateSingle
...
def main(args):
    ...
    if args.task == "StrategyQA":
        if args.debate_mode == "single":
            StrategyQADebateSingle(args)
        elif args.debate_mode == "dual":
            StrategyQADebateCompare(args)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--assistant_1', type=str, default="gpt-3.5-turbo", help='This argument assigns model for assistant 1')
    ...
    parser.add_argument('--self_elicit', type=str, default="CoT-Single", help='This argument assigns the prompting scheme for self-elicitation')
