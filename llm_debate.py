...
if __name__ == "__main__":
    ...
    parser.add_argument('--debate_agents', type=int, default=3, help='This argument assigns the num ')
    parser.add_argument('--assistant_1', type=str, default="gpt-3.5-turbo", help='This argument assigns the num ')
    parser.add_argument('--assistant_2', type=str, default="llama-3-8b-instruct", help='This argument assigns the num ')
